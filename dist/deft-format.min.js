...
angular.module("deft.format",[]).factory("DeftFormatter",function(){return{get:function(t){return new Formatter(t)}}}).directive("deftFormat",function(o){return{restrict:"A",require:"?ngModel",scope:{format:"@deftFormat"},link:function(t,r,e,n){if(n){var f=o.get(t.format);n.$parsers.unshift(function(t){return f.format(t)}),r.blur(function(){r.val(f.format(r.val()))})}}}});
